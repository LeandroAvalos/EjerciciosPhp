<?php
//Eje 25 - Avalos Leandro Sebastian
...
$producto1 = new Producto($_POST['codigoDeBarra'], $_POST['nombre'], $_POST['tipo'], $_POST['stock'], $_POST['precio']);

Producto::verificarProducto($producto1);
